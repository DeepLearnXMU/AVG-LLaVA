# Customize Components in AVG-LLaVA

This is an initial guide on how to replace the LLMs, visual encoders, etc. with your choice of components.

## LLM

It is quite simple to swap out LLaMA to any other LLMs.  You can refer to our implementation of [`llava_llama.py`](https://github.com/DeepLearnXMU/AVG-LLaVA/master/llava/model/language_model/llava_llama.py) for an example of how to replace the LLM.
...
You can check out [`clip_encoder.py`](https://github.com/DeepLearnXMU/AVG-LLaVA/blob/master/llava/model/multimodal_encoder/clip_encoder.py) on how we implement the CLIP visual encoder.
